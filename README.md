...
It provides a user-friendly GUI for handling datasets acquired with the **PREVAC EA15** hemispherical electron energy analyzer.
...
- Create a virtual environment (e.g., via Anaconda) with the required Python version to avoid changing your main environment, then run `MDC_cut.py` to automatically install the dependencies.
